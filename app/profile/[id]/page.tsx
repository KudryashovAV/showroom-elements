import ImageSlider from "@/app/components/organism/imageSlider";
import Link from "next/link";

const Profile = () => {
  return (
    <div className="font-sans antialiased text-gray-900 leading-normal tracking-wider bg-cover bg-[url('/images/backgroundImage.avif')]">
      <div className="pt-20">
        <ImageSlider />
      </div>
      ...
      <div className="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
        ...
        >
          <div className="p-4 md:p-12 text-center lg:text-left">
            <div className="block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center bg-[url('https://source.unsplash.com/MP0IUfwrn0A')]"></div>
